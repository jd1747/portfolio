...
function layerPop() {
  ...
  $("[data-pop-layer] .popBox").append(
    '<button type="button" class="btn_close"><span>�덉씠�대떕湲�</span></button>'
  );
  $("[data-pop-layer] .btn_close ,[data-pop-layer] .close").on(
    "click",
    function () {
      $("[data-pop-layer] .popBox")
        .parent("div")
        .removeClass("active")
        .fadeOut();
...
$(function () {
  setTimeout(function () {
    ...
    $(".area_visual .visual_txt")
      .children("em")
      .css("transition", "all 0.5s ease 0.4s")
      .addClass("show");
    $(".area_visual .visual_txt")
      .children("span")
      .css("transition", "all 0.5s ease 0.4s")
    ...
    $(".area_visual .visual_txt")
      .children("p")
      .css("transition", "all 0.5s ease 0.6s")
      .addClass("show");
    $(".area_visual .visual_txt")
      .children("a")
      .css("transition", "all 0.5s ease 0.8s")
      .addClass("show");
  }, 200);
});
